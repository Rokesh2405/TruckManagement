...
$getid=$_REQUEST['getid'];
    ...
    $msg = addpickup($company_name,$contact_name,$address1,$address2,$postalcode,$country,$province,$phoneno,$city,$getid);
}
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/pickup.htm"><button type="button" class="btn btn-default">Back to Listings Page</button>
                        </a>
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;">
                        ...
                        <li class="breadcrumb-item"><a href="pickup.htm"> Pickup / Delivery</a></li>
                        ...
                        <div class="row">
                          ...
                          <div class="row">
                            ...
                            <label>Company Name&nbsp;<span style="color:#FF0000;" id="alresult"> </span></label>
                              ...
                              <input type="text" name="company_name" placeholder="Enter Company Name"  id="company_name" class="form-control" value="<?php echo getpickup('company_name',$_REQUEST['banid']);?>" maxlength="50" >
                            
                          </div>
                          <div class="col-md-3">
                            <label>Contact Name</label>
                           <input type="text" name="contact_name" placeholder="Enter Contact Name"  id="contact_name" class="form-control" value="<?php echo getpickup('contact_name',$_REQUEST['banid']);?>" maxlength="50" >
                            
                            
                          </div>
                          <div class="col-md-3">
                            <label>Address 1<span style="color:#FF0000;"> </span></label>
                           <input type="text" name="address1" placeholder="Enter Address"  id="customer_address" class="form-control" value="<?php echo getpickup('address1',$_REQUEST['banid']);?>" maxlength="50">
                            
                            
                          </div>
<div class="col-md-3">
                            <label>Address 2</label>
                           <input type="text" name="address2" placeholder="Enter Address"  id="customer_address1" class="form-control" value="<?php echo getpickup('address2',$_REQUEST['banid']);?>" maxlength="50">
...
<option value="ON (Canada)" <?php if(getpickup('province',$_REQUEST['banid'])=='ON (Canada)') { ?> selected="selected" <?php } ?>>ON (Canada)</option>    
<?php
$clist = pFETCH("SELECT * FROM states WHERE `status`=?", '1');
while ($cfetch = $clist->fetch(PDO::FETCH_ASSOC)) {
?>
<option value="<?php echo $cfetch['state']; ?>" <?php if(getpickup('province',$_REQUEST['banid'])==$cfetch['state']) { ?> selected="selected" <?php } ?>><?php echo $cfetch['state']; ?></option>
<?php } ?>
</select>
                            ...
                            <div class="col-md-3">
                            <label>City</label>
                            <input type="text" class="form-control" name="city" id="city" value="<?php echo getpickup('city',$_REQUEST['banid']);?>" maxlength="50">
                          </div>
                      

                           <div class="col-md-3">
                            <label>Postal Code<span style="color:#FF0000;"> </span></label>
                           <input type="text" name="postalcode" placeholder="Enter Postal / Zip Code"  id="posta_zip_code" class="form-control" value="<?php echo getpickup('postalcode',$_REQUEST['banid']);?>" maxlength="7">
...
<option value="CANADA" <?php if(getpickup('country',$_REQUEST['banid'])=='CANADA') { ?> selected="selected" <?php } ?>>CANADA</option>
<option value="US" <?php if(getpickup('country',$_REQUEST['banid'])=='US') { ?> selected="selected" <?php } ?>>US</option>
                            </select>
                          </div>
                        </div>
                          <div class="row">
                           ...
                           <input type="text" name="phoneno" placeholder="Phone No"  id="phoneno" class="form-control" value="<?php echo getpickup('phoneno',$_REQUEST['banid']);?>" onkeyup="telformat(this.value,'phoneno');" maxlength="16">
...
<textarea name="proof_details" class="form-control" required="required"><?php echo getpickup('proof_details', $_REQUEST['banid']); ?></textarea>                          
				 </div>
							<div class="col-md-6">
                            <label>Address<span style="color:#FF0000;"> </span></label>
<textarea name="address" class="form-control" required="required"><?php echo getpickup('address', $_REQUEST['banid']); ?></textarea>                          
				 </div>
				 </div> -->
				 ...
				 <!-- <div class="row">
                         ...
                         <option value="1" <?php if(getpickup('status', $_REQUEST['banid'])=='1') { ?> selected="selected" <?php } ?>>Active</option>      
                         <option value="0" <?php if(getpickup('status', $_REQUEST['banid'])=='0') { ?> selected="selected" <?php } ?>>Inactive</option>      
                          </select></div>
						  ...
						  <!-- <div class="row">
							...
							<option value="1" <?php if(getpickup('having_insurance',$_REQUEST['banid'])=='1') { ?> selected="selected" <?php } ?>>Yes</option>
							<option value="0" <?php if(getpickup('having_insurance',$_REQUEST['banid'])=='0') { ?> selected="selected" <?php } ?>>No</option>
							</select>
						    </div>
							
							<div class="col-md-6"  <?php if(getpickup('having_insurance',$_REQUEST['banid'])=='1') { ?> style="display:block;"<?php } else { ?>style="display:none;"<?php } ?> id="ins1">
                            <label>Insurance Expiry Date <span style="color:#FF0000;"> </span></label>
                           <input type="date"  name="ins_expiry_date" placeholder="Select Expiry Date" value="<?php echo getpickup('ins_expiry_date',$_REQUEST['banid']);?>" id="ins_expiry_date" class="form-control">
                           </div>
														</div>
													<br>	
										<div class="row" >
										<div class="col-md-6" <?php if(getpickup('having_insurance',$_REQUEST['banid'])=='0') { ?> style="display:block;"<?php } else { ?>style="display:none;"<?php } ?> id="ins2">
                            <label>Name of the Insurance<span style="color:#FF0000;"> </span></label>
                           <input type="text" name="insurance_name" placeholder="Enter Insurance Name" value="<?php echo getpickup('insurance_name',$_REQUEST['banid']);?>" id="insurance_name" class="form-control">
                           </div>
									<div class="col-md-6" <?php if(getpickup('having_insurance',$_REQUEST['banid'])=='0') { ?> style="display:block;"<?php } else { ?>style="display:none;"<?php } ?> id="ins3">
                            <label>Insurance Amount<span style="color:#FF0000;"> </span></label>
                           <input type="text" name="insurance_amount" placeholder="Enter Insurance Amount" value="<?php echo getpickup('insurance_amount',$_REQUEST['banid']);?>" id="insurance_amount" class="form-control">
                           </div></div>
										</div>				
														</div></div></div> -->
                ...
                <div class="box-footer">
                    <div class="row">
                        <div class="col-md-6">
                            <a href="<?php echo $sitename; ?>master/pickup.htm">Back to Listings page</a>
                        </div>
