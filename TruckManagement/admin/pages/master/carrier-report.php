...
$url=$sitename.'MPDF/carrier-report.php?type=carrier&fromdate='.$_REQUEST['fromdate'].'&todate='.$_REQUEST['todate'];
                ...
                <div class="col-sm-12">
                  ...
                  <h4 class="page-title">Reports</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Carrier Report</li>
                    </ol>
                </div>
</div>
                <!-- /.box-header -->
...
<td><?php echo $fdepart['bill_currency'].$fdepart['bill_amount']; ?></td>
<td><?php echo date('d-m-Y',strtotime($fdepart['payment_date'])); ?></td>
<td><?php echo $fdepart['payment_currency'].$fdepart['payment_amount']; ?></td>
