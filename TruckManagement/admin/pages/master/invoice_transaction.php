                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-6">
                      <!--   <div class="btn-group pull-right m-t-15">
                        <a href="<?php echo $sitename; ?>master/addinvoice_transaction.htm"><button type="button" class="btn btn-default">Add New</button></a>                              
                    </div> -->
                    </div>
                    <!--  <div class="col-md-6">
                           <div class="btn-group pull-right m-t-15">
                  ...
                  <h4 class="page-title">Invoice Transaction</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $sitename; ?>"><?php echo getusers('name',$_SESSION['GRUID']); ?></a></li>
                        <li class="breadcrumb-item active">Invoice Transaction List</li>
                    </ol>
                </div>
</div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Invoice Transaction</h4>
...
?>
                 ...
                 <form name="listoform" id="isform" method="post" action="">
                                ...
                                <tr align="center">
                                    ...
                                    <th style="width:20%;">Shipment No</th>
                                     <th style="width:10%;">Generate Invoice</th>
...
{
var did = a;
window.location.href = '<?php echo $sitename; ?>master/' + a + '/editinvoice_transaction.htm';
}     
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=invoicetransactiontable"
    });
</script>