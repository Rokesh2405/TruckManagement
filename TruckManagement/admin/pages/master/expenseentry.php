...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Expense..?"))
            {
                return true;
            }
            else
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo $sitename; ?>master/addexpenseentry.htm"><button type="button" class="btn btn-default">Add New</button></a>                              
                    </div>
                    </div>
                    <!--  <div class="col-md-6">
                           <div class="btn-group pull-right m-t-15">
...
?>
                 ...
                 <form name="listoform" id="isform" method="post" action="">
                                ...
                                <tr align="center">
									...
									<th style="width:15%;">Expense Description</th>
...
{
var did = a;
window.location.href = '<?php echo $sitename; ?>master/' + a + '/editexpenseentry.htm';
}     
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=expenseentrytable1"
    });
</script>