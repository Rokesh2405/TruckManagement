...
$url=$sitename.'MPDF/carrier-individual-report.php?type=carrier&fromdate='.$_REQUEST['fromdate'].'&todate='.$_REQUEST['todate'].'&carrier='.$_REQUEST['carrier'];
                ...
                <div class="col-sm-12">
                  ...
                  <h4 class="page-title">Reports</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Carrier Individual Report</li>
                    </ol>
                </div>
</div>
                <!-- /.box-header -->
...
<div class="col-md-4">
    ...
    <input type="text" name="carrier" id="carrier" required="required" class="form-control" value="<?php echo $_REQUEST['carrier']; ?>">
    </div>
