...
<script type="text/javascript" >
    ...
    function checkdelete(name)
    {
        ...
        {
            if (confirm("Please confirm you want to Delete this Salesman..?"))
            {
                return true;
            }
            else
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo $sitename; ?>master/addsalesman.htm"><button type="button" class="btn btn-default">Add New</button></a>                              
                    </div>
                    </div>
                    <!--  <div class="col-md-6">
                           <div class="btn-group pull-right m-t-15">
                  ...
                  <h4 class="page-title">Salesman</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Salesman List</li>
                    </ol>
                </div>
</div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Salesman</h4>
