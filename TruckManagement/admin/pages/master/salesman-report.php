...
$url=$sitename.'MPDF/salesman-report.php?type=carrier&fromdate='.$_REQUEST['fromdate'].'&todate='.$_REQUEST['todate'].'&salesman='.$_REQUEST['salesman'];
                ...
                <div class="col-sm-12">
                  ...
                  <h4 class="page-title">Reports</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Salesman Report</li>
                    </ol>
                </div>
</div>
                <!-- /.box-header -->
