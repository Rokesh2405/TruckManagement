            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo $sitename; ?>master/adddriver.htm"><button type="button" class="btn btn-default">Add New</button></a>                              
                    </div>
                    </div>
                     <div class="col-md-6">
                           <div class="btn-group pull-right m-t-15">
                          <a href="<?php echo $sitename; ?>MPDF/driver_report.htm" target="_blank"><button type="button" class="btn btn-default">Print</button></a>                            
                    </div>
                    </div>
                     </div>   

                    
                  <h4 class="page-title">Driver Code</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $sitename; ?>"><?php echo getusers('name',$_SESSION['GRUID']); ?></a></li>
                        <li class="breadcrumb-item active">Driver Code</li>
                    </ol>
                </div>
</div>
                <!-- /.box-header -->
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Drivers</h4>
                 ...
                 <form name="form1" method="post" action="">
                                ...
                                <tr align="center">
                                    <th style="width:5%;">S.id</th>
                                     <th style="text-align: left;">Driver Code</th>
