            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo $sitename; ?>master/addpickup.htm"><button type="button" class="btn btn-default">Add New</button></a>                              
                    </div>
                    </div>
                    <!--  <div class="col-md-6">
                           <div class="btn-group pull-right m-t-15">
                  ...
                  <h4 class="page-title">Pickup / Delivery</h4>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="<?php echo $sitename; ?>"><?php echo getusers('name',$_SESSION['GRUID']); ?></a></li>
                        <li class="breadcrumb-item active">Pickup / Delivery List</li>
                    </ol>
                </div>
</div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Pickup / Delivery</h4>
...
{
var did = a;
window.location.href = '<?php echo $sitename; ?>master/' + a + '/editpickup.htm';
}     
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=pickuptable"
    });
</script>