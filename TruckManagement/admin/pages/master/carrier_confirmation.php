...
if (isset($_REQUEST['delete']) || isset($_REQUEST['delete_x'])) {
    $chk = $_REQUEST['chk'];
    $chk = implode('.', $chk);
    $msg = delcarrierconfirmation($chk);
}
?>
            ...
            <div class="container-fluid">
                ...
                <div class="col-sm-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <a href="<?php echo $sitename; ?>master/addcarrier_confirmation.htm"><button type="button" class="btn btn-default">Add New</button></a>                              
                    </div>
                    </div>
                    <!--  <div class="col-md-6">
                           <div class="btn-group pull-right m-t-15">
                  ...
                  <h4 class="page-title">Load Board</h4>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Load Board List</li>
                    </ol>
                </div>
</div>
            ...
            <div class="row">
                    <div class="col-12">
                        ...
                        <div class="card-box table-responsive">
                            <h4 class="m-t-0 header-title">List of Load Board</h4>
...
?>
                 ...
                 <form name="listoform" id="isform" method="post" action="">
                                ...
                                <tr align="center">
									...
									<th style="width:10%;">Load No</th>
									<!-- <th style="width:5%;">Pickup Date</th>
                                    <th style="width:5%;">Pickup Time</th>
                                    <th style="width:5%;">Pickup City</th>
                                    <th style="width:5%;">Delivety Date</th>
                                    <th style="width:5%;">Delivery Time</th>
                                    <th style="width:5%;">Delivery City</th> -->
...
{
var did = a;
window.location.href = '<?php echo $sitename; ?>master/' + a + '/editcarrier_confirmation.htm';
}     
</script>
<?php
...
<script type="text/javascript">
    $('#normalexamples').dataTable({
        ...
        //"scrollX": true,
        "searching": true,
        "sAjaxSource": "<?php echo $sitename; ?>pages/dataajax/gettablevalues.php?types=carrierconfirmationtable"
    });
</script>