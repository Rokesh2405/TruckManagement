...
$stmt = $db->prepare("SELECT * FROM `invoice_transaction` WHERE `id`!='0' ORDER BY `invoice_date` DESC");  
}
...
<table style="width:100%; font-family:arial; font-size:15px;border-bottom:1px solid #C72465;" border="1" cellpadding="5" cellspacing="0">
 <tr align="center">
    ...
    <th>Invoice Date</th>
    <th >Customer Name</th>
    <th align="center">Sales Amount</th>
    <th align="center">Pay Date</th>
    <th align="right">Pay Amount</th>
...
$pdate='';
 ...
 <td align="center">'.$fdepart['invoice_no'].'</td>
  ...
  <td align="center">'.$fdepart['customer_name'].'</td>
...
<div align="center"><h3 align="center">Customer Outstanding Report from '.date('M/d/Y',strtotime($_REQUEST['fromdate'])).' To '.date('M/d/Y',strtotime($_REQUEST['todate'])).'</h3>
</div>
<br>
<table width="100%">
<tr>
...
fwrite($file, $message);
$mpdf->SetTitle('Customer Outstanding Report');
...
$filename='Customer-Outstanding-report.pdf';
