...
$fbalanceamt +=$balanceamt;
 ...
 <td align="center">'.$fdepart['load_no'].'</td>
  <td align="center">'.date('d-m-Y',strtotime($fdepart['date'])).'</td>
    <td align="center">'.$fdepart['carrier'].'</td>
    ...
    <td align="center">'.date('h:i a',strtotime($fdepart['delivery_time'])).'</td>
...
<div align="center"><h3 align="center">Carrier Outstanding Report from '.date('M/d/Y',strtotime($_REQUEST['fromdate'])).' To '.date('M/d/Y',strtotime($_REQUEST['todate'])).'</h3>
</div>
<br>
<table width="100%">
<tr>
...
fwrite($file, $message);
$mpdf->SetTitle('Carrier Outstanding Report');
...
$filename='Carrier-Outstanding-report.pdf';
