...
$stmt = $db->prepare("SELECT A.`salesman_payment_date`,A.`load_no`,A.`date`,A.`salesman`,A.`salesman_commission`,B.`payment_amount` FROM `carrier_confirmation` A, `salesman_settlement` B WHERE A.`id`!='0' ORDER BY A.`date` DESC");  
}
...
$message = '<br>
<div align="center"><h2>Salesman Outstanding Report</h2></div>
<br>
<div align="left">
...
fwrite($file, $message);
$mpdf->SetTitle('Salesman Outstanding Report');
...
$filename='Salesman-Outstanding-Report.pdf';
