...
<input type="email" required="required" name="emailid" class="form-control" placeholder="Enter your Emailid">
          ...
          <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
			...
			<div class="row">
			     <!--    <div class="col-md-6 col-lg-6 col-xl-2">
                   ...
                   <a href="<?php echo $sitename; ?>master/1/editcompanydetails.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                            <img src="company.png" height="90" width="90">
                             <br>  <br>
                             <p class="text-muted mb-0" align="center">Company Mgmnt</p>
                        </div>
 ...
 <p class="text-muted mb-0" align="center">Pickup / Delivery Mgmnt</p>
                 ...
                 <!--   <div class="col-md-6 col-lg-6 col-xl-2">
                         ...
                         <a href="<?php echo $sitename; ?>master/delivery.htm">
                             
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                         <img src="delivery.png" height="90" width="90">
                        <br>  <br>
 <p class="text-muted mb-0" align="center">Delivery Mgmnt</p>
                        </div>
 ...
 <p class="text-muted mb-0" align="center">Invoice Transaction</p>
   ...
   <!--  <div class="col-md-6 col-lg-6 col-xl-2">
                    ...
                    <a href="<?php echo $sitename; ?>master/customer_settlement.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                        <img src="customers-icon-9.jpg" height="90" width="90">
                        <br>  <br>
 <p class="text-muted mb-0" align="center">Customer Settlement</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                         ...
                         <a href="<?php echo $sitename; ?>master/carrier_settlement.htm">
                             
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                         <img src="truck.png" height="90" width="90">
                        <br>  <br>
 <p class="text-muted mb-0" align="center">Carrier Settlement</p>
                        </div>
...
<!-- 
       <div class="col-md-6 col-lg-6 col-xl-2">
                   ...
                   <a href="<?php echo $sitename;?>master/drivers.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                    <img src="driver.png" height="90" width="80">
                     <br>  <br>
  <p class="text-muted mb-0" align="center">Driver Mgmnt</p>
                        </div>
                          <div class="clearfix"></div>
                    </div>
              </a>
                 ...
                 <div class="col-md-6 col-lg-6 col-xl-2">
                   ...
                   <a href="<?php echo $sitename;?>master/truck.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                    <img src="delivery.png" height="90" width="130">
                     <br>  <br>
  <p class="text-muted mb-0" align="center">Truck Mgmnt</p>
                        </div>
                          <div class="clearfix"></div>
                    </div>
              </a>
...
<div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/trailer.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                                                <img src="reports.png" height="80" width="80">
 <br>  <br>
                        <p class="text-muted mb-0" align="center">Trailer Mgmnt</p></div>
...
<!-- <div class="row">
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/extracharge.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                      
                       <img src="reports.png" height="80" width="80">
<br><br>
  <p class="text-muted mb-0" align="center">Extra Charges</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/location.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                                                <img src="reports.png" height="80" width="80">
                                                <br><br>
 <p class="text-muted mb-0">Location Mgmnt</p>
                        </div>
                 ...
                 <div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/steam_ship.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                                                <img src="reports.png" height="80" width="80">
                    ...
                    <p class="text-muted mb-0" align="center">Steam Ship Mgmnt</p>
                </div>
                ...
                </div><div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/import.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                      
                      <img src="reports.png" height="80" width="80">
                      <br><br>
  <p class="text-muted mb-0" align="center">Import Mgmnt</p>
                        </div>
                   ...
                   <div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/export.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                                                <img src="reports.png" height="80" width="80">
<br><br>
 <p class="text-muted mb-0">Export Mgmnt</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/driver_dailysheet.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                         
                          <img src="driver.png" height="80" width="80">
                       <br><br>
                        <p class="text-muted mb-0" align="center">Driver Daily Sheet</p>
                        </div>
...
<!-- <div class="row">
                <div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/driver_report.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                         <img src="driver.png" height="80" width="80">
                         <br><br>
                           <p class="text-muted mb-0" align="center">Daily Sheet Report</p>
                        </div>
                     <div class="clearfix"></div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                     <a href="<?php echo $sitename; ?>master/driver_deduction.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                   
                    <img src="driver.png" height="80" width="80">
                    <br><br>
                     <p class="text-muted mb-0" align="center">Driver Deduction</p>
                        </div>
                ...
                <div class="col-md-6 col-lg-6 col-xl-2">
                   ...
                   <a href="<?php echo $sitename;?>master/driver_sms.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                    <img src="driver.png" height="90" width="80">
                    <br><br>
<p class="text-muted mb-0" align="center">Driver SMS</p>
                        </div>
 ...
 -->               <!-- <div class="col-md-6 col-lg-6 col-xl-4">
                     <a href="<?php echo $sitename; ?>master/broker.htm">
                    <div class="widget-bg-color-icon card-box" style="height: 180px;">
                        <div class="bg-icon bg-white pull-left">
                                                <img src="reports.png" height="80" width="80">
                        ...
                        <div class="text-right">
                           ...
                           //echo $sel = $stmt->rowCount();
                            ...
                            <p class="text-muted mb-0">Broker Mgmnt</p>
                        </div>
