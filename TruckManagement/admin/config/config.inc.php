...
if ($_SERVER['HTTP_HOST'] == 'localhost') {
    $db = new PDO('mysql:host=localhost;dbname=truckmanagement;charset=utf8mb4', 'root', '');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $sitename = 'http://localhost/ttbilling/truckmanagement/admin/';
    $fsitename = 'http://localhost/ttbilling/truckmanagement/admin/';
    $fsitename1 = 'http://localhost/truckmanagement/';
    $actual_link = "http://" . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'];
    define('WEB_ROOTS', $fsitename);
    define('WEB_ROOT', $sitename);
    $docroot = $_SERVER['DOCUMENT_ROOT'] . "/finance/";
} else {
    $db = new PDO('mysql:host=localhost;dbname=truckmanagement;charset=utf8mb4', 'root', 'J"q6Hr}Lc6Rc_HRG');
    $db->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
    $db->setAttribute(PDO::ATTR_EMULATE_PREPARES, false);
    $connection_string = mysqli_connect("localhost", "root", 'J"q6Hr}Lc6Rc_HRG', "truckmanagement");
    $sitename = 'https://ttbilling.in/truckmanagement/admin/';
    $fsitename = 'https://ttbilling.in/truckmanagement/admin/';
    $fsitename1 = 'https://ttbilling.in/truckmanagement/admin/';
